<?php
         ...
         if ($this->allowedto('LAST')) echo "<input type=\"image\" name=\"sblast\" src=\"phpgrid/images/blast.gif\" width=\"24\" height=\"24\" border=\"0\" alt=\"Último\" title=\"Último\"  >";
         if ($this->allowedto('INSERT')) echo "<input type=\"image\" name=\"sbinsert\" src=\"phpgrid/images/binsert.gif\" width=\"24\" height=\"24\" border=\"0\" alt=\"Añadir\" title=\"Añadir\"  >";
