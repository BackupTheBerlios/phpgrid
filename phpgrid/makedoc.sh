#!/bin/bash
# $Id: makedoc.sh,v 1.1 2002/10/28 11:37:59 ttm Exp $ 
...
# make documentation
php $PATH_PHPDOC -d $PATH_PROJECT -t $PATH_DOCS -ti $TITLE -dn $PACKAGES \
-o $OUTPUTFORMAT:$CONVERTER -pp $PRIVATE
